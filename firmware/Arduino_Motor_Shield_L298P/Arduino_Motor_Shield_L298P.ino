...
void CtrlMotor(int leftSpeed, int rightSpeed)
{
  if(leftSpeed >= 0 && leftSpeed <= 510 && rightSpeed >= 0 && rightSpeed <= 510)
  {
    ...
    else
    {
      ...
      analogWrite(MOTOR_B_PWM, STOP_SPEED);
    }
    ...
    else
    {
      ...
      analogWrite(MOTOR_A_PWM, STOP_SPEED);
    }
  }
}
